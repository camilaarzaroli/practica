...
console.log(reversas('practica')); //el console.log muestra en la consola el selustado de los que esta entre parentesis. En este caso, la funcion reversa con la palabra practica como variable, lo que devolvera acitcarp.
console.log(reversas('1 2 3 4 5 6'));
